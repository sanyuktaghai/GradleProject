 ...
 * on 2016-02-21 at 18:58:22 UTC 
 * Modify at your own risk.
 */

package com.example.sanyukta.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://my-gradle-project.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.example.sanyukta.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.sanyukta.myapplication.backend.myApi.model.MyBean.class);
  ...
  public class TellMeAJoke extends MyApiRequest<com.example.sanyukta.myapplication.backend.myApi.model.ClassJoke> {
    ...
    protected TellMeAJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.sanyukta.myapplication.backend.myApi.model.ClassJoke.class);
    }
